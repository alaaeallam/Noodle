  ...
  return !isLoading ? (
    <div className="flex flex-col gap-2">
      ...
      <div className="relative flex items-center justify-between">
        {/* Decrease */}
        <div
          className="absolute start-2 z-10 flex h-6 w-6 cursor-pointer select-none items-center justify-center rounded-full border border-[#E4E4E7] hover:bg-slate-200"
        ...
        {/* Increase */}
        <div
          className="absolute end-2 z-10 flex h-6 w-6 cursor-pointer select-none items-center justify-center rounded-full border border-[#E4E4E7] hover:bg-slate-200"
