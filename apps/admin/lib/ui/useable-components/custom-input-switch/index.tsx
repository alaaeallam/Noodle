...
export default function CustomInputSwitch({
  ...
  return loading ? (
    ...
    <label className={`ms-2 flex flex-shrink-0 cursor-pointer items-center ${className}`} >
      <div className="relative">
        ...
        >
          <label className="relative inline-flex cursor-pointer items-center">
            ...
            <div className="absolute start-0.5 top-0.5 h-3 w-3 rounded-full bg-gray-50 transition-transform peer-checked:translate-x-4"></div>
          </label>
