          ...
          return (
            <div 
              ...
              className={`p-3 rounded-lg max-w-[80%] ${
                isAdmin 
                  ? 'bg-green-200 text-white ms-auto rounded-tr-none' 
                  : 'bg-gray-200 text-gray-800 me-auto rounded-tl-none'
              }`}
            >
              ...
              {/* Timestamp */}
              <div className="h-3 bg-gray-300 rounded-full w-32 mt-2 ms-auto"></div>
            </div>
          );
        })}
      </div>
