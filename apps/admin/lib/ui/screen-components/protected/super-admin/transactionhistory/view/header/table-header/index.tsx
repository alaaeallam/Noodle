    ...
    <div className="flex flex-row gap-4 p-4 md:flex-row md:items-center md:justify-between">
      <div className="flex flex-row gap-4 md:flex-row">
        <div className="flex flex-col">
          <Calendar
            className="w-[14rem] h-10 border-[1px] border-gray-300 rounded-[0.3rem] ps-3 pe-3 text-black"
      ...
      <div className="flex gap-4">
        <span className="p-input-icon-left">
          ...
          <InputText
            className="w-[14rem] h-10 border-[1px] font-light border-gray-300 rounded-[0.3rem] ps-3 pe-3 text-black"
