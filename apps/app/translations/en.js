export const en = {
  ...
  offTheGrillBagged: 'Off the grill, bagged',
  onTheWayToYou: 'On the way to you',
  leftAtYourGate: 'Left at your gate',
  getHelp: 'Get help',
  ...
  whereAreWeDroppingIt: 'Where are we dropping it?',
  pickSavedSpot: 'Pick a saved spot, or add a new one.',
  useMyCurrentLocation: 'Use my current location',
  saved: 'Saved',
  continueToTheBurgers: 'Continue to the burgers',
  allCategories: 'All',
  reorder: 'Reorder',
  ...
  addToBag: 'Add to bag',
  stillInYourBag: 'Still in your bag',
  resume: 'Resume',
  theWholeMenu: 'The whole menu',
  yourUsual: 'Your usual',
  switchStore: 'Switch',
  switchYourStore: 'Switch your store',
  till: 'Till',
  freeDelivery: 'Free delivery',
  yourUsualIsReady: 'Your usual is ready',
  addLastOrder: 'Add last order',
  ...
  searchItems: 'Search burgers, sliders, shakes…',
  message: 'Message',
  aptFloor: 'Apt | Floor',
